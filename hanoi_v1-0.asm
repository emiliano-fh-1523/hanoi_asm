...
inicio:
	addi t1, s0, 1		#incrementa el numero de discos por 1 para contar el espacio adicional de tamaño en el arreglo.
	...
	sw t1, (t3)		#almacena el tamaño en la primera posicion de la fuente.
